...
import oop.OnlineStore.services.ProductManagementService;
import oop.OnlineStore.services.impl.DefaultProductManagementService;
		...
		while (true) {
			...
			if(userInput.equalsIgnoreCase(CHECKOUT_COMMAND)) {
				...
				if(productToAddToCart == null) {
					System.out.println("Please, enter product ID you want to add. Or enter checkout if you want to proceed with checkout. Or enter menu if you want to navigate back to the main menu");
					continue;
				}
			}
		}
